...
//   const wordEntered = req.query.term.toUpperCase();
//   const newBooking = bookings.filter(
//     (booking) =>
//       booking.firstName.toUpperCase().includes(wordEntered) ||
//       booking.surname.toUpperCase().includes(wordEntered) ||
//       booking.email.toUpperCase().includes(wordEntered)
